...
- **CredencialesZoom** (opcional): Sala, Usuario, Contrasena — las 8 salas ya están cargadas fijas en el código (pestaña "Credenciales Zoom", visible para todos); si en algún momento cambia una contraseña, se puede cargar acá y esa versión pisa a la fija. No hace falta crear esta pestaña para que funcione.
