...
export const CHANGELOG = [
  {
    ...
    fecha: '2026-09-26',
    cambios: [
      'Inicio → "Próximas clases": el detalle de una clase de Formación ahora muestra la Fecha de inicio de la edición (tomando primero la corrección a mano ya cargada en Cronograma/Formaciones, después la confirmada por Diego, y como último recurso el cálculo automático) y, si hace falta corregirla, se puede editar desde el mismo modal — antes solo se podía ver, y solo si el cálculo automático ya la tenía bien.',
      'Alertas y feriados: cada feriado próximo ahora muestra una etiqueta junto a la fecha — "Próximamente" si faltan 30 días o menos, "Hoy" si es la fecha de hoy.',
      'Se unifica el color por sala (el mismo punto + texto de color que ya se usaba en Cronograma, Salas Zoom y Credenciales) en los lugares donde todavía se mostraba la sala como texto plano: Docentes C.O. (tarjetas de período e Historial completo), Información técnica, Masterclasses (detalle), Salas Zoom (tabla de credenciales) e Incidencias (detalle de clases superpuestas y conflictos), y en el ranking de uso por sala de Análisis.'
    ]
  },
  {
    version: '3.41.0',
    fecha: '2026-09-26',
    cambios: [
      'Cronograma: el filtro de "Día" (ej. elegir "Lunes") ahora muestra solo la columna de ese día en la vista Calendario — antes seguían apareciendo las 6 columnas de la semana, con 5 de ellas vacías.',
      'Se corrige un bug de zona horaria que afectaba a Inicio, Formaciones, Incidencias, Información técnica y Cronograma CM: la fecha de "hoy" se calculaba en UTC en vez de la hora local del navegador, lo que en Argentina hacía que desde las 21:00 la app ya pensara que era el día siguiente (por eso "Agenda de hoy" podía mostrar clases como "FINALIZADA" sin haber pasado todavía).',
      'Masterclasses: la columna "Sala / Mod." se separó en dos columnas (Sala y Moderador/a); Sala ahora usa el mismo color por sala que el resto de la app (punto + texto de color) en vez de texto plano.',
      'Masterclasses: las filas de clases que todavía no pasaron se ven con un color bien visible (antes era un verde muy tenue).'
    ]
  },
  {
    version: '3.40.0',
    fecha: '2026-09-25',
    cambios: [
      'Inicio: se corrige "Salas ocupadas" — antes podía marcar una sala como ocupada por una clase de una serie semanal aunque la clase de HOY puntual ya hubiera finalizado; ahora se fija solo en la clase real de la fecha de hoy en esa sala.',
      'Docentes C.O. → Historial completo: los períodos ya finalizados ahora se ven atenuados en toda la fila (antes solo se pintaba distinto la celda de Edición, y el resto de la fila se veía igual de "activa" aunque ya hubiera terminado).',
      'Salas Zoom → Nueva edición de Coaching Ontológico: al cargar la fecha de la 1ª clase, ahora se muestra automáticamente una vista previa con las fechas estimadas de inicio y fin de cada cuatrimestre (1°, 2° y 3°).',
      'Salas Zoom: el selector "¿Mismo docente y staff en los 3 cuatrimestres?" se hizo más chico y liviano.'
    ]
  },
  {
    version: '3.39.0',
    fecha: '2026-09-25',
    cambios: [
      'Inicio → "Próximas clases": se agrega la columna "Nº Clase", que muestra en qué clase real va la edición (ej: "Clase 25 de 48") para toda fila que sea una Formación — antes esa info iba mezclada, chiquita, adentro de la columna Curso.',
      'Inicio → Alertas activas: nueva alerta "En X días comienza: <curso> edición <N>" cuando a una edición que todavía no arrancó (ninguna clase dictada) le quedan 15 días o menos para su primera clase.'
    ]
  },
  {
    version: '3.38.0',
    fecha: '2026-09-25',
    cambios: [
      'Salas Zoom: al crear una edición completa de Coaching Ontológico (48 clases) ahora se arma la cadencia real — 16 clases, 2 semanas de receso, 16 clases, 2 semanas de receso, 16 clases — en vez de 48 clases seguidas semana a semana.',
      'Salas Zoom: al crear esa edición se pregunta si el docente y el staff van a ser los mismos en los 3 cuatrimestres o si cambian; si cambian, pide el docente/staff de cada uno (1°, 2° y 3°), diferenciados con color.',
      'Al reservar, esos 3 períodos (con sus fechas ya calculadas) se guardan solos en Docentes C.O. — antes había que cargarlos a mano ahí, cuatrimestre por cuatrimestre, y era fácil que alguno quedara sin cargar.'
    ]
  },
  {
    version: '3.37.0',
    fecha: '2026-09-25',
    cambios: [
      'Emails: la tabla de "Mails automáticos que genera el sistema" ya no necesita scroll hacia los costados — las columnas "Cuándo se envía", "A quién" y "Asunto" ahora ajustan el texto en varias líneas en vez de forzar una sola línea larga.'
    ]
  },
  {
    version: '3.36.0',
    fecha: '2026-09-25',
    cambios: [
      'Salas Zoom: al reservar una Formación ahora se puede "Guardar sin sala (queda pendiente)" — no se pierde el lugar en el cronograma (día, horario, docente) aunque en el momento no se le asigne una sala.',
      'Inicio: nueva tarjeta "⏳ Pendientes de asignar sala" con lo que se guardó sin sala — quien tiene permiso de editar el cronograma puede asignársela ahí mismo.',
      'Nuevo aviso automático por mail, todos los días a las 07:00 (solo si hay algo pendiente), avisando qué actividades faltan que alguien les asigne sala.'
    ]
  },
  {
    version: '3.35.0',
    fecha: '2026-09-25',
    cambios: [
      '"Ver como…" (arriba a la derecha, para Admin/SuperAdmin): permite previsualizar la app tal cual la ve otra persona del equipo, sin cerrar tu propia sesión — para revisar qué ve y qué puede tocar cada rol antes de darle un permiso. Mientras dura la previsualización queda claramente marcado con un cartel arriba de todo, y no se puede guardar ni borrar nada de verdad (se sale con un clic en cualquier momento).',
      'Inicio: en "Agenda de hoy" y en "Próximas clases", la Sala ahora usa el mismo color por sala que el resto de la app.'
    ]
  },
  {
    version: '3.34.0',
    fecha: '2026-09-25',
    cambios: [
      'Historial de acciones: la tabla ahora se pagina de a 100 registros para que no quede pesada con muchos resultados cargados — el buscador de arriba sigue filtrando sobre todo lo cargado, no solo la página actual.',
      'Inicio: en "Próximas clases", la franja de color de la izquierda (clase mañana / dentro de 48hs) ya no se pisaba con el texto de la fecha.',
      'Credenciales de las salas de Zoom: la columna Sala ahora usa el mismo color por sala que el resto de la app.'
    ]
  },
  {
    version: '3.33.0',
    fecha: '2026-09-25',
    cambios: [
      'Incidencias: se corrigió de raíz que Coaching Educativo 62 (y cualquier edición en su misma situación) siguiera figurando "superpuesta" en Sala 6 aunque Formaciones ya la mostrara Finalizada al 100% — antes, para descartar el horario recurrente de una edición terminada, Incidencias solo miraba las clases cargadas en el horario en vivo (que en varias ediciones viejas quedaron incompletas), y ahora también mira el mismo histórico real que ya usan Formaciones e Inicio para saber si una edición terminó.',
      'Docentes C.O.: en el Historial completo, la columna Cuatrimestre ahora se completa sola según el orden cronológico de los períodos de cada edición (el más viejo es 1er cuatrimestre, el siguiente 2do, etc.) cuando no está cargada a mano, y la columna Sala se completa con la sala real de las clases ya agendadas de esa edición cuando el período en sí no la tiene cargada.',
      'Docentes C.O.: la lista de "Ediciones" ahora se ordena de la más reciente a la más vieja dentro de cada estado (Activas/Futuras/Finalizadas) — la Edición 1 es la más antigua de todas.',
      'Cronograma: en la vista "Lista", la columna Sala ahora usa el mismo color por sala que ya se puede elegir en el Calendario ("Colorear por: Sala"), en vez de texto plano sin distinguir.',
      'Agenda de hoy: las clases que ya terminaron ahora dicen "✓ FINALIZADA" en vez de no mostrar ningún cartel.',
      'Información técnica: cada registro (Masterclass, Auditorio, etc.) ahora dice "✓ FINALIZADA" o "PRÓXIMAMENTE" según si su fecha ya pasó.',
      'Emails: la tabla de mails automáticos es más ancha para que "A quién" no se corte en varias líneas.'
    ]
  },
  {
    version: '3.32.0',
