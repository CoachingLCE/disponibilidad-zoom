...
export const CHANGELOG = [
  {
    ...
    cambios: [
      ...
      'Pendiente para el próximo mensaje (mail de Sofía, avisame si arranco): pestaña Docentes y Staff de C.O, pestaña Clases especiales/Información técnica, panel de usuarios/contraseñas de Zoom, vínculo de salas especiales con Salas Zoom, y las fechas puntuales de CE 62 y CO 40-54 (necesito que confirmes cuáles son las correctas).'
    ]
  },
  {
    version: '2.2.5',
