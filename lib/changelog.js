...
export const CHANGELOG = [
  {
    ...
    cambios: [
      ...
      'Pendiente (necesito info tuya para seguir): pestaña Clases especiales/Información técnica (decime qué campos necesita, no tengo el Excel de referencia); el email de Paula (para darle el mismo permiso que a Sofía en Docentes C.O); y las fechas correctas de CE 62 y CO 40-54 para cargarlas en la pestaña Formaciones.'
    ]
  },
  {
    version: '2.3.0',
